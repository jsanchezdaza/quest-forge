...
export const en = {
  ...
  'game.yourAdventure': 'Your adventure',
  'game.yourOptions': 'Your options',
  'game.location': 'Current location',
  'game.locationPlaceholder': 'Village of Millhaven',
  'game.dayTime': 'Day / Time',
  'game.dayTimePlaceholder': 'Day 1, 08:30',
  'game.gold': 'Gold',
  'game.status': 'Status',
  'game.statusHealthy': 'In good shape',
  'game.statusWounded': 'Wounded',
  'game.statusBadlyWounded': 'Badly wounded',
  'game.statusUnconscious': 'Unconscious',
