...
export const es: typeof en = {
  ...
  'game.saveGame': 'Guardar partida',
  'game.yourAdventure': 'Tu aventura',
  'game.yourOptions': 'Tus opciones',
  'game.location': 'Ubicación actual',
  'game.locationPlaceholder': 'Aldea de Millhaven',
  'game.dayTime': 'Día / Hora',
  'game.dayTimePlaceholder': 'Día 1, 08:30',
  'game.gold': 'Oro',
  'game.status': 'Estado',
  'game.statusHealthy': 'En buen estado',
  'game.statusWounded': 'Herido',
  'game.statusBadlyWounded': 'Malherido',
  'game.statusUnconscious': 'Inconsciente',
