    ...
    <Card variant="game">
      <div className="prose prose-invert max-w-none">
        <div className="bg-background-darker rounded-lg p-6 mb-6 border border-medieval-gold/20 h-64 overflow-y-auto">
          <p className="text-gray-100 text-lg leading-relaxed whitespace-pre-line font-medieval-narrative">
            {scene.narrative}
          </p>
        </div>
          ...
          <div className="space-y-3">
            ...
            {scene.choices.map((choice, index) => (
              <Button
                ...
                disabled={loading}
                className="w-full text-left justify-start p-4 h-auto font-medieval-options font-normal text-lg uppercase tracking-wide"
              >
        ...
        {scene.player_choice && (
          <div className="bg-medieval-gold/10 border border-medieval-gold/30 rounded-lg p-4">
            <p className="text-medieval-gold font-medieval-options text-lg">
